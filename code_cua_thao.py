...
def build_post_url ():
    url="https://www.facebook.com/VietnamPizzaHut/?fref=ts" #nhập rồi sau đó cách một cái
...
def mail():
    ...
    list_status=[]
    list_like=[]
    prom_mail_list = Restaurant8.objects
    l = []
    for i in prom_mail_list:
        l.append(i)
    a= l[0]
    body = str.format("Subject:mới có thông tin mới\n {0}, {1}, {2}, {3}, {4}, {5}",
                      a['message'], a['created_time'], a['likes'], a['shares'], a['comments'], a['score'])
    email= request.form['dinhmenh2']
    user_name = "dracarys1312"
    password = "0987150152Pt"
    from_addr = "dracarys1312@gmail.com"
    to_addr = "dpson1995@gmail.com"
